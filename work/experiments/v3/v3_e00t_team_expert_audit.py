...
N_TRAIN = 5000
N_CLASSES = 60
WYH_V2_OOF_PRED = ROOT / "work" / "outputs" / "oof" / "MODEL-V2_oof.csv"
WYH_V2_OOF_PROBA = ROOT / "work" / "outputs" / "probabilities" / "V2-B-REFONLY_oof_probabilities_seg.csv.gz"
WYH_V2_TEST_PROBA = ROOT / "work" / "outputs" / "probabilities" / "V2-B-REFONLY_test_probabilities_seg.csv.gz"
WYH_V2_METRICS = ROOT / "work" / "outputs" / "metrics" / "model_v2_metrics.json"
TEAM_FOLDS = ROOT / "work" / "experiments" / "team_folds_5_seed42.csv"
...
Exact paths, SHAs, and eligibility reasons: `work/outputs/v3/v3_e00t_expert_manifest.json`.
...
Canonical analysis partition: `work/experiments/team_folds_5_seed42.csv` (`StratifiedKFold(n_splits=5, shuffle=True, random_state=42)`).
...
See `work/outputs/v3/v3_e00t_tables/reliability_feature_inventory.csv`.
...
def main() -> int:
    ...
    report_path = ROOT / "work" / "reports" / "v3" / "v3_e00t_team_expert_audit.md"
