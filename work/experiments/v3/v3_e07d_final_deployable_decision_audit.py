...
E05A_REGISTRY = ROOT / "work" / "outputs" / "v3" / "v3_e05a_four_expert_registry.parquet"
M0_OOF = ROOT / "work" / "outputs" / "oof" / "MODEL-V2_oof.csv"
M0_VAL_PROBA = ROOT / "work" / "outputs" / "probabilities" / "V2-B-REFONLY_oof_probabilities_seg.csv.gz"
...
M2_VAL = ROOT / "work" / "outputs" / "v3" / "v3_e06m_m2_validation.csv"
M2_VAL_PROBA = ROOT / "work" / "outputs" / "v3" / "v3_e06m_m2_validation_probabilities.csv.gz"
M2_TEST_PROBA = ROOT / "work" / "outputs" / "v3" / "v3_e06m_m2_test_probabilities.csv.gz"
E06M_COMP = ROOT / "work" / "outputs" / "v3" / "v3_e06m_complementarity.json"
E06M_CMP = ROOT / "work" / "outputs" / "v3" / "v3_e06m_candidate_comparison.csv"
E06M_DELTAS = ROOT / "work" / "outputs" / "v3" / "v3_e06m_cell_deltas.csv"
E06M_NEW = ROOT / "work" / "outputs" / "v3" / "v3_e06m_new_unique_recoveries.csv"
PRED_PATH = ROOT / "prediction" / "prediction.csv"
OUT_DIR = ROOT / "work" / "outputs" / "v3"
TABLE_DIR = OUT_DIR / "v3_e07d_tables"
REPORT_PATH = ROOT / "work" / "reports" / "v3" / "v3_e07d_final_deployable_decision_audit.md"
...
FROZEN_PATHS = [
    ...
    ROOT / "work" / "reports" / "v3" / "v3_e00t_team_expert_audit.md",
    ROOT / "work" / "reports" / "v3" / "v3_e02d_privileged_gene_distillation.md",
    ROOT / "work" / "reports" / "v3" / "v3_e03a_rescue_audit.md",
    ROOT / "work" / "reports" / "v3" / "v3_e04s_sni_source_expert.md",
    ROOT / "work" / "reports" / "v3" / "v3_e05a_directional_complementarity_audit.md",
    ROOT / "work" / "reports" / "v3" / "v3_e06m_source_balanced_multireference.md",
    PRED_PATH,
]
...
Canonical analysis partition: `work/experiments/team_folds_5_seed42.csv`. Folds 3-4 are a retrospective stability partition, not an untouched holdout.
...
Accuracy by confidence decile is in `work/outputs/v3/v3_e07d_calibration_audit.csv`.
...
def main() -> None:
    ...
    if MODEL_V3_DOC.is_file():
        integrity_failure("work/docs/versions/model_v3.md already exists; E07D must not freeze MODEL V3")
