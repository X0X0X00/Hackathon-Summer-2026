...
| Submission candidate | `work/experiments/evidence/submissions/model_v1.csv` (5000 rows; official contract) |
...
Requires the project virtualenv (`pandas`, `numpy`, `scikit-learn`, `scipy`, `pytest` as pinned in `work/requirements.txt` at the V1 freeze). Official CSVs must match the saved manifest.
...
# frozen 3-fold YW-004 OOF (does not regenerate work/experiments/folds.csv)
work/.venv/bin/python work/scripts/02_sprint2_experiments.py

# full-train MODEL V1 candidate (refuses to overwrite unless passed)
work/.venv/bin/python work/scripts/06_model_v1.py

# submission contract
work/.venv/bin/python work/scripts/90_validate_submission.py work/experiments/evidence/submissions/model_v1.csv

# V1 tests
work/.venv/bin/python -m pytest work/tests/test_model_v1.py work/tests/test_folds.py work/tests/test_official_contract.py work/tests/test_submission_contract.py -q
```
...
| Location | Role |
|---|---|
| `work/src/merfish60/model_v1.py` | Frozen full-train YW-004 implementation |
| `work/src/merfish60/signatures.py` | Signature keys, candidate maps, mask-and-renormalize |
| `work/src/merfish60/models.py` | Shared `LR_KWARGS` and `log1p` helpers |
| `work/src/merfish60/validate_submission.py` | Official CSV contract |
| `work/scripts/06_model_v1.py` | Train / predict / write submission candidate |
| `work/scripts/02_sprint2_experiments.py` | YW-002/003/004 OOF |
| `work/scripts/01_baseline.py` | YW-000/001 OOF |
| `work/scripts/04_sprint3_experiments.py` | YW-005/006/007 (not selected) |
| `work/scripts/90_validate_submission.py` | CLI validator |
| `work/scripts/10_official_manifest.py` | Manifest verify |
| `work/tests/test_model_v1.py` | V1 leakage and contract tests |
| `work/experiments/folds.csv` | Frozen 3-fold assignments |
| `work/experiments/registry.csv` | Experiment log (YW-000..YW-007) |
| `work/experiments/official_data_manifest.json` | Official CSV hashes |
| `work/experiments/evidence/metrics/` | Per-run JSON, including `model_v1_metrics.json` |
| `work/experiments/evidence/submissions/model_v1.csv` | Submission candidate |
| `work/reports/sprint2_comparison.md` | Sprint 2 comparison |
| `work/reports/sprint3_comparison.md` | Sprint 3 comparison |
