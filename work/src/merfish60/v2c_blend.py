...
EXPERT_A_OOF = "work/outputs/probabilities/BRIDGE-YW004-5F_oof_probabilities.csv.gz"
EXPERT_B_OOF = "work/outputs/probabilities/V2-A-SPATIAL-LGBM_oof_probabilities_ei.csv.gz"
EXPERT_C_OOF = "work/outputs/probabilities/V2-B-REFONLY_oof_probabilities_seg.csv.gz"
...
EXPERT_A_TEST = "work/outputs/probabilities/model_v1_test_probabilities.csv.gz"
EXPERT_B_TEST = "work/outputs/probabilities/V2-A-SPATIAL-LGBM_test_probabilities.csv.gz"
EXPERT_C_TEST = "work/outputs/probabilities/V2-B-REFONLY_test_probabilities_seg.csv.gz"
