...
@pytest.mark.skipif(
    not (OUT / "v3_e03a_three_expert_registry.parquet").is_file(),
    reason="regenerable E03A registry not retained",
)
...
@pytest.mark.skipif(
    not (OUT / "v3_e03a_dangerous_overrides.csv").is_file(),
    reason="regenerable E03A override dump not retained",
)
